...
if act="1" then
	...
	On Error Resume Next
		...
		txtTitulo = Upload.Form("txtTextoTitulo")
	...
	addSQL = "INSERT INTO "&prefixoTabela&"banner (foto, link, titulo, texto, ultima_alteracao) values ('"&txtArquivo&"','"&txtlink&"','"&txtTitulo&"','"&txtTexto&"','"&ultima_alteracao&"')"
...
elseif act="2" then
	...
	if txtArquivo="" then
	set addRs=Server.CreateObject("ADODB.recordset")
	editSQL = "UPDATE "&prefixoTabela&"banner SET link='"& txtlink &"', titulo='"& txtTitulo &"', texto='"& txtTexto &"', ultima_alteracao='"& ultima_alteracao &"' WHERE id="&id
	addRs.open editSQL, Conexao
	else
	set addRs=Server.CreateObject("ADODB.recordset")
	editSQL = "UPDATE "&prefixoTabela&"banner SET foto='"& txtArquivo &"', link='"& txtlink &"', titulo='"& txtTitulo &"', texto='"& txtTexto &"', ultima_alteracao='"& ultima_alteracao &"' WHERE id="&id
	addRs.open editSQL, Conexao	
	end if
