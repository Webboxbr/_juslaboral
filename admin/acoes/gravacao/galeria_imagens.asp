...
if act="1" then
	...
	addSQL = "INSERT INTO "&prefixoTabela&"galeriaimagens (foto, nome, resumo, ultima_alteracao) values ('"&txtArquivo&"','"&txtnome&"','"&txtresumo&"','"&ultima_alteracao&"')"
...
elseif act="2" then
	...
	set addRs=Server.CreateObject("ADODB.recordset")
	editSQL = "UPDATE "&prefixoTabela&"galeriaimagens SET foto='"& txtArquivo &"', nome='"& txtnome &"', resumo='"& txtResumo &"', ultima_alteracao='"& ultima_alteracao &"' WHERE id="&id
