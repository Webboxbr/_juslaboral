...
if act="1" then
	...
	addSQL = "INSERT INTO "&prefixoTabela&"segunda_fase (nome, ultima_alteracao) values ('"&nome&"','"&ultima_alteracao&"')"
...
elseif act="2" then
	...
	set addRs=Server.CreateObject("ADODB.recordset")
	editSQL = "UPDATE "&prefixoTabela&"segunda_fase SET nome='"&nome&"', ultima_alteracao='"&ultima_alteracao&"' WHERE id="&id
