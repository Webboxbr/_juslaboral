...
if act="1" then
	...
	addSQL = "INSERT INTO "&prefixoTabela&"galeriavideos (video, foto, ultima_alteracao) values ('"&txtvideo&"','"&txtArquivo&"','"&ultima_alteracao&"')"
...
elseif act="2" then
	...
	set addRs=Server.CreateObject("ADODB.recordset")
	editSQL = "UPDATE "&prefixoTabela&"galeriavideos SET video='"& txtvideo &"', foto='"& txtArquivo &"', ultima_alteracao='"& ultima_alteracao &"' WHERE id="&id
