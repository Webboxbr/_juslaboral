...
%>
	...
	<form id="formCadastro" name="formCadastro" method="POST" enctype="multipart/form-data" action="_gravacao.asp?tipo=15&act=1">
		<label for="txtArquivo">Banner(*) (Tamanho recomendado: 609 x 387 pixels)<br />
    	<input name="txtArquivo" type="file" id="txtArquivo" /></label>
	  	
	  	<label for="txtLink">Link<br />
	    <input type="url" name="txtLink" id="txtLink"/></label>	   

	    <label for="txtTextoTitulo">T&iacute;tulo<br />
	    <input type="text" name="txtTextoTitulo" id="txtTextoTitulo"/></label>

	    <label for="txtTexto">Texto banner<br />
...
%>
	...
	<form id="formCadastro" name="formCadastro" method="POST" enctype="multipart/form-data" action="_gravacao.asp?tipo=15&act=2&id=<%=id%>">
		<label for="txtArquivo">Banner(*) (Tamanho recomendado: 609 x 387 pixels)<br />
    	<input name="txtArquivo" type="file" id="txtArquivo" /></label>	
	  	
	  	<label for="txtLink">Link<br />
	    <input type="url" name="txtLink" id="txtLink" value="<%=rsBanner("link")%>"/></label>

	    <label for="txtTextoTitulo">T&iacute;tulo<br />
	    <input type="text" name="txtTextoTitulo" id="txtTextoTitulo" value="<%=rsBanner("titulo")%>" /></label>

	    <label for="txtTexto">Texto banner<br />
	    <textarea name="txtTexto" id="txtTexto"><%=rsBanner("texto")%></textarea></label> 	        
...
elseif act="3" then
	...
	response.redirect("_listas.asp?tipo=15&act=1")
